...
@endif
        <div class="mt-6 bg-white shadow-sm rounded-lg divide-y">
            ...
            <form action="{{ url('add_booking') }}" method="POST">
                ...
                <!-- User ID -->
                <div class="mt-4">
                    <x-text-input id="userId" class="mt-4 bg-primary d-inline-block" type="text" name="userId" :value="Auth::user()->id" hidden/>
                </div>

                <!-- Room ID -->
                <div class="mt-4">
                    <x-text-input id="roomId" class="block mt-1 w-full" type="hidden" name="roomId" :value="2" />
                </div>
